    ...
    <section style={{ background: "var(--color-bg)", padding: "0", fontFamily: "'DM Sans',sans-serif" }}>
      <div style={{ maxWidth: 1280, margin: "0 auto", padding: "0 40px 110px" }}>
        ...
        <div style={{
          ...
          <iframe
            title="Stratedgee Office Location"
  ...
  return (
    <section style={{ background: "var(--color-surface-alt)", padding: "110px 0", fontFamily: "'DM Sans',sans-serif" }}>
      <div style={{ maxWidth: 1280, margin: "0 auto", padding: "0 40px" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 80, alignItems: "start" }}>
          <div>
            <h2 style={{ fontFamily: "'Playfair Display',serif", fontSize: "clamp(32px,4vw,48px)", fontWeight: 700, color: "var(--color-text-strong)", lineHeight: 1.15, letterSpacing: -0.5, marginBottom: 20 }}>
              Got Questions?<br />
