  ...
  return (
    <section style={{ background: "var(--color-bg)", padding: "100px 0", fontFamily: "'DM Sans',sans-serif", position: "relative", overflow: "hidden" }}>
      ...
      <div style={{
        ...
        fontFamily: "'Playfair Display',serif", fontSize: 180, fontWeight: 900,
        ...
        <div className="mv-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 3 }}>
          {[
            ...
            >
              ...
              <h3 style={{ fontFamily: "'Playfair Display',serif", fontSize: "clamp(22px,2.5vw,30px)", fontWeight: 700, color: "var(--color-text-strong)", lineHeight: 1.25, marginBottom: 20 }}>
                {headline}
              </h3>
          ...
          {values.map(({ icon: Icon, num, label, desc }) => (
            ...
            >
              ...
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 28 }}>
                ...
                <span style={{ color: "var(--color-accent-soft)", fontFamily: "'Playfair Display',serif", fontSize: 32, fontWeight: 700, opacity: 0.4 }}>{num}</span>
              </div>

              <h3 style={{ fontFamily: "'Playfair Display',serif", color: "var(--color-text-strong)", fontSize: 20, fontWeight: 600, marginBottom: 14, lineHeight: 1.3 }}>{label}</h3>
...
function Milestones() {
  const timeline = [
    { year: "2020", title: "Founded", desc: "The Stratedgee established in Chennai with a small, passionate team and a big vision." },
  ...
  return (
    <section style={{ background: "var(--color-bg)", padding: "100px 0", fontFamily: "'DM Sans',sans-serif" }}>
      <div style={{ maxWidth: 1280, margin: "0 auto", padding: "0 40px" }}>
        ...
        <h2 style={{ fontFamily: "'Playfair Display',serif", fontSize: "clamp(32px,4vw,48px)", fontWeight: 700, color: "var(--color-text-strong)", lineHeight: 1.15, letterSpacing: -0.5, marginBottom: 70 }}>
            ...
            {timeline.map(({ year, title, desc }, i) => (
              ...
              >
                ...
                <div style={{ paddingLeft: 0, textAlign: "right", paddingRight: 24 }}>
                  <span style={{ fontFamily: "'Playfair Display',serif", fontSize: 20, fontWeight: 700, color: "var(--color-accent)" }}>{year}</span>
                </div>
                ...
                {/* Content */}
                <div>
                  <div style={{ fontFamily: "'Playfair Display',serif", fontSize: 18, fontWeight: 600, color: "var(--color-text-strong)", marginBottom: 6 }}>{title}</div>
  ...
  const team = [
    {
      ...
      initials: "RP",
      bio: "B.E. Electronics & Communication, Vel Tech University. 5+ years blending analytical precision with creative storytelling. Specialises in data-driven advertising, performance metrics, and AI-driven growth strategies.",
      highlight: "Founder",
    },
    {
      name: "RenukaDevi",
      ...
      initials: "RD",
      bio: "Leads end-to-end campaign execution across SEO, social media, and paid channels. Drives measurable results through creative strategy and data-backed decisions.",
      highlight: "Strategy",
    },
    {
      name: "Kavya",
      ...
      initials: "KV",
      bio: "Builds and nurtures client partnerships, identifying growth opportunities and ensuring seamless onboarding and long-term retention.",
      highlight: "Growth",
    },
    {
      name: "Diana",
      role: "Client Sourcing Executive",
      initials: "DI",
      bio: "Drives new business acquisition through targeted outreach, prospecting, and relationship-building across industries in Chennai and beyond.",
      highlight: "Outreach",
    },
  ];
      ...
      <div style={{ maxWidth: 1280, margin: "0 auto", padding: "0 40px" }}>
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", marginBottom: 60, flexWrap: "wrap", gap: 16 }}>
          <h2 style={{ fontFamily: "'Playfair Display',serif", fontSize: "clamp(32px,4vw,48px)", fontWeight: 700, color: "var(--color-text-strong)", lineHeight: 1.15, letterSpacing: -0.5 }}>
            The Extraordinary Team<br /><span style={{ color: "var(--color-accent)" }}>Behind The Stratedgee</span>
          </h2>
          <p style={{ color: "var(--color-text-soft)", fontSize: 14, maxWidth: 300, lineHeight: 1.7, fontWeight: 300 }}>
            15 passionate professionals. One shared mission: your growth.
          </p>
        </div>
        ...
        <div className="team-grid" style={{ display: "grid", gridTemplateColumns: "repeat(4,1fr)", gap: 2 }}>
          {team.map(({ name, role, initials, bio, highlight }) => (
            <div
              ...
              onMouseLeave={() => setHovered(null)}
              style={{
                background: hovered === name ? "var(--color-surface-strong)" : "var(--color-surface-alt)",
                border: hovered === name ? "1px solid var(--color-border-strong)" : "1px solid var(--color-border-soft)",
                padding: "36px 28px",
                transition: "all 0.25s",
            ...
            >
              ...
              <div style={{
                ...
                <span style={{ fontFamily: "'Playfair Display',serif", fontSize: 22, fontWeight: 700, color: "var(--color-accent-contrast)" }}>{initials}</span>
              </div>
              ...
              <div style={{
                ...
                <span style={{ color: "var(--color-accent)", fontSize: 10, letterSpacing: 2, textTransform: "uppercase", fontWeight: 600 }}>{highlight}</span>
              </div>

              <h3 style={{ fontFamily: "'Playfair Display',serif", color: "var(--color-text-strong)", fontSize: 18, fontWeight: 700, marginBottom: 4, lineHeight: 1.3 }}>{name}</h3>
              <div style={{ color: "var(--color-accent)", fontSize: 11, letterSpacing: 2, textTransform: "uppercase", fontWeight: 600, marginBottom: 16 }}>{role}</div>
              <p style={{ color: "var(--color-text-faint)", fontSize: 13, lineHeight: 1.8, fontWeight: 300 }}>{bio}</p>
            </div>
          ))}
        </div>
      </div>
      <style>{`@media(max-width:900px){.team-grid{grid-template-columns:repeat(2,1fr)!important;}}@media(max-width:600px){.team-grid{grid-template-columns:1fr!important;}}`}</style>
    </section>
  );
}
          ...
          <div>
            <div style={{
              ...
              <div style={{
                ...
                <span style={{ fontFamily: "'Playfair Display',serif", fontSize: 36, fontWeight: 900, color: "var(--color-accent-contrast)" }}>RP</span>
              </div>

              <h3 style={{ fontFamily: "'Playfair Display',serif", fontSize: 24, fontWeight: 700, color: "var(--color-text-strong)", marginBottom: 6 }}>
                Rajendra Prasad
              </h3>
